...
public record LazyRectangle(int Width, int Height)
{
...
public record LazyRectangleCloneCtor(int Width, int Height)
{
    private static int EvaluateArea(int Width, int Height) => Width * Height;
...
public record LazyRectangle2Ctor//(int Width, int Height) // Moved to Ctor
{
